      ...
      >
        ...
        <div className="relative h-48 w-full overflow-hidden bg-slate-100 dark:bg-slate-800">
          ...
          {(item.potentialMatchesCount > 0 || item.matchScore) && (
            <div className="absolute top-3 right-3 bg-blue-600/90 text-white text-[14px] font-bold px-2.5 py-1 rounded-full backdrop-blur-xs flex items-center gap-1 shadow-md">
        ...
        <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              {item.verified && (
                <span className="inline-flex items-center gap-1 text-[14px] font-semibold text-blue-600 dark:text-blue-400">
          ...
          {/* Metadata Section */}
          <div className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800 text-base text-slate-500 dark:text-slate-400">
            ...
            {itemType === "FOUND" &&
              ...
              item.status !== "CLAIMED" && (
                <Button
                  ...
                  className="text-base rounded-xl gap-1"
                >
                  Claim Item
