      ...
      <Card className="p-6 transition-all" hover>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4 pb-3 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-600 text-white flex items-center justify-center font-black text-base shadow-md shadow-blue-500/20">
              {match.matchScore}%
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div className="p-3.5 rounded-2xl bg-rose-50/60 dark:bg-rose-950/20 border border-rose-200/60 dark:border-rose-900/40 flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <span className="text-base font-extrabold uppercase text-rose-600 dark:text-rose-400 tracking-wider">
                Reported Lost
              </span>
              <h5 className="text-base font-bold text-slate-900 dark:text-white truncate">
                {match.lostItem?.name}
              </h5>
              <div className="text-base text-slate-500 dark:text-slate-400 flex items-center gap-1 mt-0.5 truncate">
          ...
          <div className="p-3.5 rounded-2xl bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-200/60 dark:border-emerald-900/40 flex items-center gap-3">
            ...
            />
            <div className="min-w-0 flex-1">
              <span className="text-base font-extrabold uppercase text-emerald-600 dark:text-emerald-400 tracking-wider">
                Turned In / Found
              </span>
              <h5 className="text-base font-bold text-slate-900 dark:text-white truncate">
