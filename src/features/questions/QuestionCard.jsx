      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0 space-y-2.5">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {isAccepted && (
              <span className="inline-flex items-center gap-1 text-[14px] font-bold px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800">
