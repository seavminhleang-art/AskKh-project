...
export default function WorkspaceTopbar({ mode = 'user' }) {
  ...
  return (
    <header className={`sticky top-0 z-40 flex h-16 shrink-0 items-center border-b px-4 sm:px-6 ${mode === 'admin' ? 'admin-topbar' : 'border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950'}`}>
