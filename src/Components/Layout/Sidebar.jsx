  ...
  return (
    <>
      <div className="flex h-16 shrink-0 items-center gap-2 border-b border-gray-100 px-4 dark:border-gray-700">
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gray-900 text-lg font-semibold text-white dark:bg-white dark:text-gray-900">
          N
        </div>
        {!collapsed && (
          <>
