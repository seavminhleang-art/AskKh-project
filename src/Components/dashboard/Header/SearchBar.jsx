  ...
  return (
    <div className="relative w-full max-w-[440px]">
      ...
      <input
        ...
        placeholder="Search for lost items, found items, or locations..."
        className="w-full h-[34px] pl-8 pr-7 text-xs rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-800/50 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:bg-white dark:focus:bg-slate-900 focus:outline-none focus:ring-1.5 focus:ring-blue-500/40 focus:border-blue-500 transition-all"
      />
      {query && (
        <button
          type="button"
