...
export default function NavigationItem({
  ...
  const content = (
    <>
      ...
      {badge !== null && badge !== undefined && (
        <span
          className={`shrink-0 w-4 h-4 rounded-full flex items-center justify-center text-[16px] font-bold leading-none ${
            badgeColor === "rose"
  ...
  const className = `w-full flex items-center justify-between px-3 py-2 rounded-lg text-lg transition-all duration-150 cursor-pointer select-none group ${
    active
