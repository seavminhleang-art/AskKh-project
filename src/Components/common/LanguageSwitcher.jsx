...
export default function LanguageSwitcher({ className = "" }) {
  ...
  const toggleLanguage = () => {
    ...
    setLang(nextLang);
    toast.info(
      `Language switched to ${nextLang === "KH" ? "Khmer (ភាសាខ្មែរ)" : "English"}`,
    );
  };
