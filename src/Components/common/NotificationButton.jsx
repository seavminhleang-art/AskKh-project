...
export default function NotificationButton({ className = "" }) {
  ...
  return (
    ...
    >
      ...
      {displayCount > 0 && (
        <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 bg-[#EF4444] text-white text-[14px] font-bold rounded-full flex items-center justify-center ring-2 ring-white dark:ring-slate-950">
