...
export default function LostAndFoundPage() {
  ...
  return (
    <div
      ...
      className={`shared-theme shared-page relative min-h-screen px-4 sm:px-6 lg:px-10 xl:px-16 py-10 overflow-hidden font-sans cursor-default transition-colors duration-300 ${
    ...
    >
      ...
      <motion.div
        className={`hidden lg:flex fixed top-0 left-0 pointer-events-none z-50 flex items-center justify-center px-3 py-1.5 rounded-full backdrop-blur-md text-base font-medium ${
          darkMode
