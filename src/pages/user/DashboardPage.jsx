    ...
    <div className="space-y-8">
      ...
      <div className="rounded-3xl bg-gradient-to-r from-blue-700 via-indigo-700 to-slate-900 text-white p-6 sm:p-8 shadow-xl relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="space-y-2 max-w-xl">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-white text-sm font-semibold backdrop-blur-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/dashboard/matches" className="text-sm font-semibold text-blue-600 dark:text-blue-400 hover:underline">
              View all
            </Link>
          </div>

          {activeMatches.length === 0 ? (
            <Card className="p-6 text-center text-sm text-slate-400 border-dashed">
              ...
              {activeMatches.slice(0, 2).map((m) => (
                <Card key={m.id} className="p-4 border-slate-200 dark:border-slate-800" hover>
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Link to="/dashboard/matches">
                      <Button size="sm" variant="outline" className="text-sm rounded-xl">
                        Review
                      </Button>
                    </Link>
                  </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/dashboard/claims" className="text-sm font-semibold text-blue-600 dark:text-blue-400 hover:underline">
              View all
            </Link>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/dashboard/questions" className="text-sm font-semibold text-blue-600 dark:text-blue-400 hover:underline">
              Activity History
            </Link>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/dashboard/notifications" className="text-sm font-semibold text-blue-600 dark:text-blue-400 hover:underline">
              All alerts
            </Link>
          </div>
