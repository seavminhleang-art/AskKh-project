  ...
  if (!USE_MOCK_API) {
    return (
      <div>
        <PageHeader
          title="Marketplace"
          description="Buy and sell listings across campus."
        />
        <Card className="p-10">
          <EmptyState
            icon={Store}
            title="Marketplace API not available"
            description="No marketplace endpoints exist in the current API specification yet."
          />
        </Card>
      </div>
    );
