...
export default function Users() {
  ...
  const columns = [
    ...
    },
    {
      ...
      label: "Activity",
      sortable: true,
      render: (u) => `${u.reputation.toLocaleString()} rep`,
    },
    { key: "joined", label: "Created", sortable: true },
    {
      ...
      render: (u) => (
        <div className="flex items-center gap-1">
          ...
          <button
            onClick={() =>
              showToast(`Editing ${u.name} is not implemented yet.`, "info")
            }
            className="p-1.5 text-gray-400 hover:text-brand-primary transition-colors"
            aria-label="Edit"
          >
          ...
          <button
            ...
            className="p-1.5 text-gray-400 hover:text-brand-secondary transition-colors"
            aria-label="Delete"
          >
            <Trash2 size={15} />
          </button>
    ...
    <div>
      ...
      {toDelete && (
        <ConfirmDialog
          ...
          onConfirm={() =>
            showToast(`${toDelete.name} was deleted.`, "success")
          }
          title="Delete user"
